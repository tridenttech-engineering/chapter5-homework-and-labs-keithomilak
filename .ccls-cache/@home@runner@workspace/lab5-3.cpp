...
int main()
{
	const double premierDiscountRate = 0.10;
	const double normalDiscountRate = 0.05;
	double discount = 0.0;
	...
	if (premierClub == true) {
		discount = purchaseAmount * premierDiscountRate;
	}
	else{
		discount = purchaseAmount * normalDiscountRate;
	}//end if
